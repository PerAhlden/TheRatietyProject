	...
	application.Configure(func(cfg *application.Configurator) {
		...
		cfg.RootViewWithDecoration(".", func(wnd core.Window) core.View {
			return VStack(
				...
				Text("Sie möchten auch mal ihre Meinung äußern, weil man Ihnen sonst nie zuhört? Sie reden jeden Tag mit "+
					...
					"können sie anhand von alltäglichen Fragen, die sich viele stellen Ihre Meinung kundtun. Und für ein bisschen"+
					" mehr Spaß gibt es die Rangliste. Hier werden sie sehen wer die meisten Umfragen gewinnt. Also was lesen sie "+
					"hier noch so blöd rum? Machen sie sich auf, stimmen sie ab und erklimmen sie die obersten Gipfel der Rangliste. "+
